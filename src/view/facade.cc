...
void Facade::ScaleModel(QString &sliderName) {
  if (sliderName == "horizontalSlider_scale") {
    double rate = pow(10, ui->horizontalSlider_scale->value() / 60.0) / 100;
